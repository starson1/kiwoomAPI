def errors(err_code):
    ...
    -302: ('OP_ERR_ACC_USE', '타인계좌사용오류'),
    -303: ('OP_ERR_MIS_2BILL_EXC', '주문가격20억초과'),
    -304: ('OP_ERR_MIS_5BILL_EXC', '주문가격50억초과'),
    ...
    -309: ('OP_ERR_MIS_3OOCNT_EXC', '주문수량300계약초과'),
